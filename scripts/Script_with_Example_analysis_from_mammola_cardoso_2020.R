...
comm2 <- read.table("comm.txt")
traits2 <- read.table("traits.txt")
...
gower.mat_spider <- gower.dist(traits)
...
## No difference in dispersion between isolated vs connected subplots
